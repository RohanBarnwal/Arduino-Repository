...
char auth[] = "HhcXqspoHVdbhDJFR42d1tKQbvAA-t-L";

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "Rohan";
char pass[] = "rohanbarnwal1";
...
int isButtonPressed = !digitalRead(2);
  ...
  Blynk.email("rohanbarnwal08@gmail.com", "Subject", "My Blynk project is online.");
...
void loop(){
  ...
  if (isButtonPressed) // You can write any condition to trigger e-mail sending
  {
    ...
    Blynk.email("rohanbarnwal08@gmail.com", "Subject: Button Logger", body);
