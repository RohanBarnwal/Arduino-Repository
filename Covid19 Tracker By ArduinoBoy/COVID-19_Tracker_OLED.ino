 ...
 #include "images.h"  // Include custom images
  ...
  const char* url1 = "/apps/thinghttp/send_request?api_key=5KJAPLY0705BZGWE";     //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=W28ODVS3YWSYJTG0";   //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=JEFK22DAJC4HSSE6";   //Recovered
  ...
  void drawFrame3(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y) {
    ...
    display->setTextAlignment(TEXT_ALIGN_CENTER);
    display->setFont(ArialMT_Plain_16);
    display->drawString(64,15, "ACTIVE"); 
  ...
  void drawFrame5(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y) {
   ...
   display->setTextAlignment(TEXT_ALIGN_CENTER);
   display->setFont(ArialMT_Plain_16);
   display->drawString(64,15, "DISCHARGE");
